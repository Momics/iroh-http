/**
 * iroh-http stress tests — Node.js
 *
 * Tests high concurrency, large payloads, rapid lifecycle churn,
 * and resource behavior under load.
 *
 * Usage:
 *   cd node && node ../tests/stress/test-node.mjs
 */
