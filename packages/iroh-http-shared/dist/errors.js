...
exports.IrohHandleError = exports.IrohArgumentError = exports.IrohAbortError = exports.IrohProtocolError = exports.IrohStreamError = exports.IrohConnectError = exports.IrohBindError = exports.IrohError = void 0;
exports.classifyError = classifyError;
exports.classifyBindError = classifyBindError;
// ── Base class ────────────────────────────────────────────────────────────────
/**
...
exports.IrohBindError = IrohBindError;
/**
...
exports.IrohConnectError = IrohConnectError;
...
exports.IrohStreamError = IrohStreamError;
...
exports.IrohProtocolError = IrohProtocolError;
/** The operation was aborted via `AbortSignal`.  Mirrors the web platform `AbortError`. */
class IrohAbortError extends IrohError {
...
exports.IrohAbortError = IrohAbortError;
/** Invalid argument passed by the caller. */
class IrohArgumentError extends IrohError {
...
exports.IrohArgumentError = IrohArgumentError;
/** Slab handle is invalid or expired. */
class IrohHandleError extends IrohStreamError {
    constructor(message, code = "INVALID_HANDLE") {
        super(message, code);
        this.name = "IrohHandleError";
        Object.setPrototypeOf(this, new.target.prototype);
    }
}
exports.IrohHandleError = IrohHandleError;
// ── Classification ────────────────────────────────────────────────────────────
/**
