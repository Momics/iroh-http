...
|----------|----------------|
| [http-engine.md](http-engine.md) | hyper/tower integration, request lifecycle, body/trailer bridge, duplex |
...
| [wire-format.md](wire-format.md) | Wire encoding, ALPN versioning, trailer protocol, duplex handshake |
