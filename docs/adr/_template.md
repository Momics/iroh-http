...
date: YYYY-MM-DD
area: api | transport | ffi | security | testing | identity | ecosystem
tags: []
---
...
Facts, constraints, or findings gathered so far — from code, experiments,
prior art, or discussion. This section can grow over time as more is learned.

## Options considered

If alternatives have been identified, list them here with brief notes on
trade-offs. This section is optional when the space is still being defined.
